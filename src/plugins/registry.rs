...
impl PluginRegistry {
        ...
        self.plugins
            ...
            .filter(|(_, metadata)| {
                metadata
                    .manifest
                    .anti_pattern_types
                    .contains(&anti_pattern.to_string())
            })
            .map(|(id, _)| id.clone())
            .collect()
    }
    ...
    pub fn get_statistics(&self) -> RegistryStatistics {
        ...
        let anti_patterns: std::collections::HashSet<String> = self
            .plugins
            .values()
...
mod tests {
    ...
    async fn test_plugin_registry() {
        ...
        let plugin_id = registry
            .register_plugin(manifest.clone(), binary.to_vec())
            .await
            .unwrap();
