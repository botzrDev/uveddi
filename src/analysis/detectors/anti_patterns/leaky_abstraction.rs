...
impl LeakyAbstractionDetector {
    ...
    fn analyze_rust_file(
        ...
        let tree = parsed_file
            .tree
            .as_ref()
            .ok_or_else(|| AnalysisError::DependencyExtractionError("No AST available".to_string()))?;
        ...
        let query = Query::new(&language, query_source)
            .map_err(|e| AnalysisError::DependencyExtractionError(format!("Failed to create Rust query: {}", e)))?;
