...
impl MemoryTracker {
    ...
    pub fn allocate(&self, component: &str, size_bytes: u64) -> ResourceResult<MemoryGuard> {
        ...
        if *current + size_bytes > limit {
            self.record_allocation_event(component, size_bytes, AllocationEventType::Failed);
        ...
        *current += size_bytes;
        ...
        self.record_allocation_event(component, size_bytes, AllocationEventType::Allocated);
    ...
    pub fn update_limit(&self, new_limit: u64) -> ResourceResult<()> {
        ...
        if new_limit < current {
            return Err(ResourceError::InvalidConfiguration(format!(
    ...
    fn record_allocation_event(&self, component: &str, size: u64, event_type: AllocationEventType) {
