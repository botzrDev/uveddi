...
mod config_service_tests {
    ...
    fn test_configuration_mutations() {
        ...
        assert_eq!(service.get_config_value("test_key"), Some("test_value".to_string()));
        ...
        assert_eq!(service.get_cache_path(), Some(PathBuf::from("custom_cache.db")));
...
mod plugin_manager_tests {
    ...
    async fn test_plugin_manager_disabled_plugins() {
        ...
        let load_result = handle.load_plugin(std::path::PathBuf::from("test.wasm")).await;
...
mod dependency_graph_builder_tests {
    ...
    use super::super::traits::{DependencyGraphBuilder, AstProvider};
    use super::super::ast_provider::AstProviderImpl;
...
mod integration_tests {
    ...
    async fn test_components_integration() {
        ...
        let config_service = Arc::new(ConfigurationService::new()) as Arc<dyn traits::ConfigurationService>;
        let ast_provider = Arc::new(AstProviderImpl::new().unwrap()) as Arc<dyn traits::AstProvider>;
