...
use uveddi::analysis::memory::{
    MemoryOptimizationConfig, initialize_memory_optimization,
    get_optimization_status, BASIC_MEMORY_METRICS, DETECTOR_POOLS,
...
async fn test_global_allocator() {
    ...
    {
        use uveddi::analysis::memory::{is_optimized_allocator, get_allocator_info};
