...
pub fn build_api_key_patterns() -> Result<HashMap<String, SecretPattern>, AnalysisError> {
    ...
    patterns.insert(
        ...
        SecretPattern {
            ...
            remediation: "Use AWS IAM roles or environment variables for AWS credentials"
                .to_string(),
            cwe_id: Some(798),
            tags: vec![
                "aws".to_string(),
    ...
    patterns.insert(
        ...
        SecretPattern {
            ...
            remediation: "Store API keys in environment variables or secure secret management"
                .to_string(),
            cwe_id: Some(798),
    ...
    patterns.insert(
        ...
        SecretPattern {
            ...
            remediation: "Store Slack tokens in environment variables or secure token management"
                .to_string(),
            cwe_id: Some(798),
