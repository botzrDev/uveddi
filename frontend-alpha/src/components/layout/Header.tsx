        ...
        <div className={itemsClasses}>
          ...
          {variant === 'landing' && isOnLandingPage ? (
            ...
            <div className="flex items-center mb-0" style={{ gap: '2px' }}>
              <img src="/logo(blue).png" alt="Uveddi Logo" className="w-10 h-10 rounded-lg mr-0" />
              <h1 className="font-mono text-2xl font-bold bg-gradient-to-r from-gray-900 to-slate-700 dark:from-white dark:to-slate-300 bg-clip-text text-transparent tracking-wider">veddi</h1>
            </div>
          ) : (
