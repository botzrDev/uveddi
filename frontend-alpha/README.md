# Uveddi Frontend Alpha

This is the **alpha testing** frontend for the Uveddi platform.

> ⚠️ **Alpha Testing Notice**: This is an early preview version for alpha testers only. Features may be incomplete or unstable.
