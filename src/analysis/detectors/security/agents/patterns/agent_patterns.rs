    ...
    fn create_issue_from_match(
        ...
        SecurityIssue {
            ...
            location: SecurityLocation {
                ...
                start_line: pattern_match.line_number as i32,
                end_line: pattern_match.line_number as i32,
                start_column: Some(pattern_match.column_start as i32),
                end_column: Some(pattern_match.column_end as i32),
                function_name: None,
                class_name: None,
                module_name: None,
            },
