...
use crate::tui::{app::AppState, messages::AppMessage, ui::components::logo::UveddiLogo};
use ratatui::{
...
impl MainMenu {
        ...
        Self {
            ...
            items: vec![
                MenuItem {
                    ...
                    description: "Run comprehensive code analysis with customizable parameters"
                        .to_string(),
                    icon: "📊".to_string(),
                    shortcut: '1',
                ...
                MenuItem {
                    ...
                    description: "Manage application settings, AI providers, and preferences"
                        .to_string(),
                    icon: "⚙️".to_string(),
                    shortcut: '2',
                ...
                MenuItem {
                    ...
                    description: "Browse analysis results with interactive viewers and exports"
                        .to_string(),
                    icon: "📋".to_string(),
                    shortcut: '3',
                ...
                MenuItem {
                    ...
                    description: "Install, configure, and monitor WASM analysis plugins"
                        .to_string(),
                    icon: "🔌".to_string(),
                    shortcut: '4',
    ...
    fn render_logo_header(&self, frame: &mut Frame, area: Rect, app_state: &AppState) {
        ...
        let subtitle_content = Paragraph::new(vec![Line::from(vec![
            Span::styled(
    ...
    fn render_footer(&self, frame: &mut Frame, area: Rect, app_state: &AppState) {
        ...
        let status_paragraph = Paragraph::new(status_lines).block(
            Block::default()
                .borders(Borders::ALL)
                .title("Status")
                .style(Style::default().fg(Color::Blue)),
...
mod tests {
    ...
    fn test_quick_access_shortcuts() {
        ...
        assert!(matches!(
            messages.first(),
            Some(AppMessage::NavigateToAnalyze)
        ));

        let messages = menu.handle_key_input(KeyCode::Char('2'), &mut app_state);
        assert!(matches!(
            messages.first(),
            Some(AppMessage::NavigateToConfig)
        ));
    }
