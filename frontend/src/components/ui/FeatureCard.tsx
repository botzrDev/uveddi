...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    <div className={`group relative bg-secondary-800 hover:bg-secondary-750 border border-secondary-700 hover:border-secondary-600 rounded-xl p-6 transition-all duration-300 hover:scale-105 hover:shadow-glow ${className}`}>
      ...
      <h3 className="font-display text-headline-sm font-headline text-white mb-3 group-hover:text-primary-400 transition-colors">
        {title}
      </h3>
      <p className="font-sans text-body-md font-body text-secondary-300 leading-relaxed">
        {description}
      </p>
