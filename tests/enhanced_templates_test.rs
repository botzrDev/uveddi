...
async fn test_enhanced_template_system_creation() {
    ...
    let template_system = EnhancedPromptTemplateSystem::new(
        context_selector,
        optimization_config,
    );
...
async fn test_god_object_template_generation() {
    ...
    println!("✅ God Object template generated with {} tokens", 
...
async fn test_token_budget_optimization() {
    ...
    println!("✅ Token budget optimization: {}/{} tokens ({}% efficiency)", 
             enhanced_prompt.token_usage.total_tokens,
             1000,
...
async fn test_ai_integration_layer() {
    ...
    let mut knowledge_ai = KnowledgeEnhancedAIEngine::new(
        ai_engine,
        template_system,
        config,
    );
    ...
    println!("✅ AI integration layer working: {} patterns used", 
...
async fn test_template_performance() {
    ...
    println!("✅ Template generation performance: {}ms", generation_time.as_millis());
}
...
async fn test_comprehensive_template_coverage() {
    ...
    for analysis_type in analysis_types {
        let enhanced_prompt = template_system
            ...
            .await
            .expect(&format!("Failed to generate template for {:?}", analysis_type));
...
fn create_mock_enhanced_patterns() -> HashMap<String, crate::ai::knowledge::language_integration::EnhancedPattern> {
...
impl crate::ai::engine::AIEngine {
    pub fn new_mock() -> Self {
        ...
        Self::new(crate::ai::config::AIConfig::default())
            .expect("Failed to create mock AI engine")
    }
}